...
**Алгоритм**
1. Создать класс `Point` с свойствами `X` и `Y` типа `double`
2. Реализовать конструктор, принимающий обе координаты

<img width="471" height="249" alt="Снимок экрана 2025-10-21 184647" src="https://github.com/user-attachments/assets/7bb1455d-7e23-4226-83c9-afdde9686986" />
<img width="865" height="306" alt="Снимок экрана 2025-10-21 184734" src="https://github.com/user-attachments/assets/49fbded7-ef95-4663-8871-bfd50254b7e6" />
...
**Алгоритм**
1. Создать класс `Line` со свойствами `Start` и `End` типа `Point`
2. Реализовать конструктор, принимающий начальную и конечную точки

<img width="546" height="519" alt="Снимок экрана 2025-10-21 184931" src="https://github.com/user-attachments/assets/6e933e1a-cd28-4630-904c-f9b7679d2c30" />
...
**Алгоритм**
1. Модифицировать класс `Point`, сделав свойства `X` и `Y` доступными только для чтения
...
**Алгоритм**
1. Модифицировать класс `Student`
